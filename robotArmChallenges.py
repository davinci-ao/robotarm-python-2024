...
challenges_basic =  {
    ...
    5 : {'start': ',x', 'solution': hasSolution, 'criteria':'r:0,y:2', 'name': 'sort 1 box', 'symbols':'x-ry', 'levels': '2:12,3:11/5', 
...
challenges_intermediate = {
    ...
    3 : {'name':'whites to the right','start' : 'x,x,x,x,x,x,x,x,x,', 'symbols': 'x-wwwwwwrgbrgbrgb', 'solution': hasSolution,'criteria':'w>1','scans':'5:9','levels':'2:17,3:17/55','info':'move all white boxes one spot to the right'},
...
challenges_advanced = {
    1 : {'name':'move all stacks','start' : 'b,2g,3w,4r', 'solution': ',,,,,b,2g,3w,4r'},
    2 : {'name':'reds to the end','start' : 'x,x,x,x,x,x,x,x,x,', 'symbols': 'x-rrrrwgbywgby', 'solution': hasSolution,'criteria':'r:9'},
    3 : {'name':'stack distributed to the right','start' : '???*?,,,,,,,,,','solution': hasSolution, 'criteria':'0}1', 'levels':'2:25,3:17/63'},
    4 : {'name':'sort in stacks: rgb','start' : 'x,x,x,x,x,x,,r,g,b', 'symbols':'x-rrrrbbbbgggg', 'solution': hasSolution,'criteria':'r:7,g:8,b:9'},
    5 : {'name':'democratie','start' : ',x,x,x,x,x,x,x,x,x', 'symbols':'x-rrrryyyybbbb', 'solution': hasDemocratie, 'levels':'2:35,3:35/110'},
}
