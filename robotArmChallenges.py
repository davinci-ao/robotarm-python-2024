...
challenges_advanced = {
    ...
    5 : {'name':'democratie','start' : ',x,x,x,x,x,x,x,x,x', 'symbols':'x-rrrrryyyyybbbbb', 'solution': hasDemocratie, 'example':getDemocratieSolution,'levels':'2:35,3:35/110','info':'collect all boxes of most common color on spot 0. If equally common collect boxes of the first color found'},
}
